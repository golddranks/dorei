...
try:
	text_to_audio = pickle.load(open(prefix+'dorei/text_to_audio.pickle', 'rb'))
except FileNotFoundError:
	text_to_audio = {}
try:
	audio_to_text = pickle.load(open(prefix+'dorei/audio_to_text.pickle', 'rb'))
except FileNotFoundError:
	audio_to_text = {}
...
def spottaa_clip(l_text, r_text, l_audio, r_audio, filename):
	...
	pickle.dump(text_to_audio, open(prefix+'dorei/text_to_audio.pickle', 'wb'))
	...
	pickle.dump(audio_to_text, open(prefix+'dorei/audio_to_text.pickle', 'wb'))
